...
{
    [CreateAssetMenu(fileName = "New LoadSceneRequest Event", menuName = "Game Events/LoadSceneRequest Event")]
    public class LoadSceneRequestEvent : BaseGameEvent<LoadSceneRequest> { }
}