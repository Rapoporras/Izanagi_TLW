...
{
    [CreateAssetMenu(fileName = "New SeiryuAttackInfo Event", menuName = "Game Events/SeiryuAttackInfo Event")]
    public class SeiryuAttackInfoEvent : BaseGameEvent<SeiryuAttackInfo> { }
}